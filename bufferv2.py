...
class ReplayBuffer():
    ...
    def __init__(self, batch_size, gamma=0.99, 
                ...
                comp_return=True, act_chunk=1, hd=False):
...
if __name__ == "__main__":
    ...
    batch_size = 256
    buffer = ReplayBuffer(batch_size=batch_size, gamma=0.995, weight=None, stack=3, sub_goal=25, comp_return=False)
    ...
    buffer = ReplayBuffer(batch_size=batch_size, gamma=0.995, weight=None, stack=0, sub_goal=25, comp_return=False)
    buffer.load_ogbench(dataset_path=dataset_path)
    for i in range(100):
